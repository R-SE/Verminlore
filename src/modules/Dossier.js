...
export class Dossier extends React.Component {
  render () {
    return (
      <div>
        <h1>Dossier</h1>
        <p>Anim id laborum, qui laborum familiaritatem, aut de ipsum laboris, export
          ...
          transferrem, aliqua sempiternum expetendis eram ingeniis. Excepteur e doctrina.
          Expetendis et mandaremus, se sed familiaritatem. Fugiat voluptate voluptate,
          doctrina eruditionem ab mentitum, litteris labore aut litteris graviterque eu si
